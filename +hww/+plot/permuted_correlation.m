...
base = Container.concat( base.enumerate({'monkeys', 'doses'}) );
norm = Container.concat( norm.enumerate({'monkeys', 'doses'}) );
...
real_base2 = real_base;
real_base2( 'group' ) = 'group2';
real_base = real_base.append( real_base2 );
