...
startDirectory = '/Users/hannahweinberg-wolf/Documents/5HTP_FV_Analysis_Code/codes_for_hannah/temp_test_data';
...
data = getDur_hannah2(output_allTimes,allEvents,pos);
...
rawFixNumPerSession{doses}{imageCategory} = 1;
rawFixNumPerSession{doses}
