...
% [nogenderlabels_raw]=collapse_across('gender',lookLabels);
 %%%total collapse
[facelabels] = collapse_across({'gender','expression','gaze'},trialLabels);
...
%%% Pull out individual expressions D/I with gender collapsed
...
%Pull out by dose
[SCRsaline,SCRsaline_labs] = separate_data_struct(storeLookingDuration,lookLabels,'doses',{'saline'});
[SCRlow,SCRlow_labs] = separate_data_struct(storeLookingDuration,lookLabels,'doses',{'low'});
[SCRhigh,SCRhigh_labs] = separate_data_struct(storeLookingDuration,lookLabels,'doses',{'high'});
%% plot
%SCRnormgaze
[means,errors] = means_and_errors_plot(norm_look_dur_gaze,norm_look_dur_labels_gaze, ...
    'yLabel','Looking Duration normalized within session by scrambled images','yLimits',[0 2],'xtickLabel',{'Directed','Averted'});
%SCRnormgender
[means,errors] = means_and_errors_plot(norm_look_dur_gender,norm_look_dur_labels_gender, ...
    'yLabel','Looking Duration normalized within session by scrambled images','yLimits',[0 2],'xtickLabel',{'Male','Female'});
%SCRnormexpression
[means,errors] = means_and_errors_plot(norm_look_dur_expression,norm_look_dur_labels_expression, ...
    'yLabel','Looking Duration normalized within session by scrambled images','yLimits',[0 2],'xtickLabel',{'Lip Smack','Neutral','Fear Grimace','Threat'});
%SCRnormnogender
[means,errors] = means_and_errors_plot(norm_look_dur_nogender,norm_look_dur_labels_nogender, ...
    'yLabel','Looking Duration normalized within session by scrambled images','yLimits',[0 2],'xtickLabel',{'Directed Lip Smack','Directed Neutral','Directed Fear Grimace','Directed Threat','Averted Lip Smack','Averted Neutral','Averted Fear Grimace','Averted Threat'});

%SCRnorm EXPRESSION
%scrnorm threat
[means,errors] = means_and_errors_plot(SCRthreat,SCRthreat_labs, ...
    'yLabel','Looking Duration normalized within session by scrambled images', 'yLimits',[0 2],'xtickLabel', {'Directed Threat','Averted Threat'});
%scrnorm neutral
[means,errors] = means_and_errors_plot(SCRneutral,SCRneutral_labs, ...
    'yLabel','Looking Duration normalized within session by scrambled images', 'yLimits',[0 2],'xtickLabel', {'Directed Neutral','Averted Neutral'});
%scrnorm LS
...
[means,errors] = means_and_errors_plot(SCRFG,SCRFG_labs, ...
    'yLabel','Looking Duration normalized within session by scrambled images', 'yLimits',[0 2],'xtickLabel', {'Directed Fear Grimace','Averted Fear Grimace'});

%%number of completed trials
[means,errors] = means_and_errors_plot(completetrials_all,triallabels_all,'yLabel','Completed Trials','xLabel','Drug Dose','title','Average Trials Completed per Session','xtickLabel',' ');

% %RAWgaze
% [means,errors] = means_and_errors_plot(norm_look_dur_gaze_raw,norm_look_dur_labels_gaze_raw, ...
%     'yLabel','Looking Duration normalized within session by scrambled images','xtickLabel',{'Directed','Averted'});
% %RAWgender
% [means,errors] = means_and_errors_plot(norm_look_dur_gender_raw,norm_look_dur_labels_gender_raw, ...
%     'yLabel','Looking Duration normalized within session by scrambled images','xtickLabel',{'Male','Female'});
% %RAWexpression
% [means,errors] = means_and_errors_plot(norm_look_dur_expression_raw,norm_look_dur_labels_expression_raw, ...
%     'yLabel','Looking Duration normalized within session by scrambled images','xtickLabel',{'Lip Smack','Neutral','Fear Grimace','Threat'});
% %RAWnogender
% [means,errors] = means_and_errors_plot(norm_look_dur_nogender_raw,norm_look_dur_labels_nogender_raw, ...
%     'yLabel','Looking Duration normalized within session by scrambled images','xtickLabel',{'Directed Lip Smack','Directed Neutral','Directed Fear Grimace','Directed Threat','Averted Lip Smack','Averted Neutral','Averted Fear Grimace','Averted Threat'});
